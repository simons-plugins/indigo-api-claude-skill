...
**Cross-references**: Integration docs use same device/variable object structure as Indigo Object Model docs. If user asks about object properties, also load `docs/api/iom/devices.md` or relevant IOM file.
